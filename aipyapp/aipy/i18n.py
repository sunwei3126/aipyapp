...
MESSAGES = {
    'zh': {
        ...
        'execute_result': '执行结果',
        'mcp_init': '正在初始化MCP服务器，如果是第一次加载，可能会耗时较长，请耐心等待...',
        'call_tool': '开始调用MCP工具',
        'call_tool_result': 'MCP工具调用结果',
        'found_mcp': '从{0}个启用的MCP服务器找到{1}个工具',
        'mcp_info': "MCP服务器：{}，工具：{}",
        'mcp_status': 'MCP服务器状态: {}',
        ...
        "tt_share_url": "https://store.aipyaipy.com/api/work",
        "tt_aio_url": "https://api.trustoken.cn/aio-api",
    ...
    'en': {
        ...
        'mcp_init': 'Initializing MCP server, this may take a while if it\'s the first load, please wait patiently...',
        'call_tool': 'Start calling MCP tool',
        'call_tool_result': 'MCP tool call result',
        'found_mcp': 'Found {1} tools from {0} enabled MCP servers',
        'mcp_info': "MCP Server: {}, tools: {}",
        'mcp_status': 'MCP server status: {}',
        'Start parsing message': 'Start parsing message',
        'Message parse result': 'Message parse result',
        ...
        "tt_share_url": "https://store.aipy.app/api/work",
        "tt_aio_url": "https://sapi.trustoken.ai/aio-api",
